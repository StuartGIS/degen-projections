...
st.header("Wyndham Championship")
st.markdown("Sedgefield Country Club  \nGreensboro, North Carolina, USA  \nAugust 6-9, 2026")
...
draft_results = pd.read_csv("Wyndham_draft_results_csv.csv")
...
st.write("Updated August 3, 2026, after Rocket Classic completion.")
...
if relevant_files:
    ...
    avg_stats['Season Earnings'] = avg_stats['Drafter'].map({'Alex': '$80', 'Dave': '$130', 'Stu': '$80'})
    ...
    geography_wins = pd.Series({'Alex': 6, 'Dave': 4, 'Stu': 18})
...
st.write("This table includes all players from all tournaments. Updated August 3, 2026, after Rocket Classic completion.")

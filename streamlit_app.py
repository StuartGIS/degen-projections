...
st.header("Fedex St. Jude Championship")
st.markdown("TPC Southwind  \nMemphis, Tennessee, USA  \nAugust 13-16, 2026")
...
draft_results = pd.read_csv("FedexStJude_draft_results_csv.csv")
...
st.write("Updated August 18, 2026 after Fedex St. Jude completion.")
...
if relevant_files:
    ...
    avg_stats['Season Earnings'] = avg_stats['Drafter'].map({'Alex': '$80', 'Dave': '$140', 'Stu': '$90'})
    ...
    geography_wins = pd.Series({'Alex': 7, 'Dave': 4, 'Stu': 19})
...
st.write("This table includes all players from all tournaments. Updated August 18, 2026 after Fedex St. Jude completion.")

...
st.header("Houston Open")
st.markdown("Memorial Park Golf Course  \nHouston, Texas  \nMarch 26-29, 2026")
...
draft_results = pd.read_csv("Houston_draft_results_csv.csv")
...
if relevant_files:
    ...
    avg_stats['Season Earnings'] = avg_stats['Drafter'].map({'Alex': '$40', 'Dave': '$50', 'Stu': '$10'})
    ...
    geography_wins = pd.Series({'Alex': 1, 'Dave': 3, 'Stu': 6})

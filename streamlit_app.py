...
st.header("Truist Championship")
st.markdown("Quail Hollow  \nCharlotte, North Carolina  \nMay 7-10, 2026")
...
draft_results = pd.read_csv("Truist_draft_results_csv.csv")
...
st.write("Updated May 3, 2026, after Cadillac completion.")
...
if relevant_files:
    ...
    avg_stats['Season Earnings'] = avg_stats['Drafter'].map({'Alex': '$50', 'Dave': '$60', 'Stu': '$40'})
    ...
    geography_wins = pd.Series({'Alex': 4, 'Dave': 3, 'Stu': 8})
...
st.write("This table includes all players from all tournaments. Updated May 3, 2026, after Cadillac completion.")

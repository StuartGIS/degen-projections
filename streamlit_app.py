...
st.write("Updated June 23, 2026, after US Open completion.")
...
if relevant_files:
    ...
    avg_stats['Season Earnings'] = avg_stats['Drafter'].map({'Alex': '$60', 'Dave': '$120', 'Stu': '$50'})
    ...
    geography_wins = pd.Series({'Alex': 6, 'Dave': 4, 'Stu': 12})
...
st.write("This table includes all players from all tournaments. Updated June 23, 2026, after US Open completion.")

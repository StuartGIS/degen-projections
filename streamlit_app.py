...
st.write("Updated May 11, 2026, after Truist completion.")
...
if relevant_files:
    ...
    avg_stats['Season Earnings'] = avg_stats['Drafter'].map({'Alex': '$50', 'Dave': '$70', 'Stu': '$40'})
    ...
    geography_wins = pd.Series({'Alex': 5, 'Dave': 3, 'Stu': 8})
...
st.write("This table includes all players from all tournaments. Updated May 11, 2026, after Truist completion.")

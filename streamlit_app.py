...
st.header("John Deere Classic")
st.markdown("TPC Deere Run  \nSilvis, Illinois  \nJuly 2-5, 2026")
...
draft_results = pd.read_csv("JohnDeere_draft_results_csv.csv")
...
st.write("Updated June 29, 2026, after Travelers completion.")
...
if relevant_files:
    ...
    avg_stats['Season Earnings'] = avg_stats['Drafter'].map({'Alex': '$60', 'Dave': '$130', 'Stu': '$50'})
    ...
    geography_wins = pd.Series({'Alex': 6, 'Dave': 4, 'Stu': 13})
...
st.write("This table includes all players from all tournaments. Updated June 29, 2026, after Travelers completion.")

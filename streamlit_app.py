...
st.header("Amgen Irish Open")
st.markdown("Trump International Golf Links & Hotel  \nDoonbeg, Ireland  \nSeptember 10-13, 2026")
...
draft_results = pd.read_csv("AmgenIrish_draft_results_csv.csv")
...
st.write("Updated September 16, 2026 after Amgen Irish completion.")
...
if relevant_files:
    ...
    avg_stats['Season Earnings'] = avg_stats['Drafter'].map({'Alex': '$90', 'Dave': '$160', 'Stu': '$100'})
    ...
    geography_wins = pd.Series({'Alex': 7, 'Dave': 6, 'Stu': 21})
...
st.write("This table includes all players from all tournaments. Updated September 16, 2026 after Amgen Irish completion.")

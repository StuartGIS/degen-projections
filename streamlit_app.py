...
st.header("The Genesis Invitational")
st.markdown("Riviera Country Club  \nPacific Palisades, California  \nFebruary 19-22, 2026")
...
draft_results = pd.read_csv("genesis_riviera_draft_results_csv.csv")
...
st.write("Updated Feb 22, 2026, after Genesis (Riv) completion.")
...
if relevant_files:
    ...
    avg_stats['Season Earnings'] = avg_stats['Drafter'].map({'Alex': '$20', 'Dave': '$40', 'Stu': '$0'})
    ...
    geography_wins = pd.Series({'Alex': 0, 'Dave': 3, 'Stu': 3})

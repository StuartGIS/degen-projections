...
st.header("US Open")
st.markdown("Shinnecock Hills Golf Club  \nSouthampton, New York, USA  \nJune 18-21, 2026")
...
draft_results = pd.read_csv("USopen_draft_results_csv.csv")
...
st.write("Updated June 14, 2026, after Canadian completion.")
...
if relevant_files:
    ...
    avg_stats['Season Earnings'] = avg_stats['Drafter'].map({'Alex': '$60', 'Dave': '$100', 'Stu': '$50'})
    ...
    geography_wins = pd.Series({'Alex': 5, 'Dave': 4, 'Stu': 12})
...
st.write("This table includes all players from all tournaments. Updated June 14, 2026, after Canadian completion.")

...
st.header("Scottish Open")
st.markdown("The Renaissance Club  \nDirleton, North Berwick, Scotland  \nJuly 9-12, 2026")
...
draft_results = pd.read_csv("Scottish_draft_results_csv.csv")
...
st.write("Updated July 13, 2026, after Scottish Open completion.")
...
if relevant_files:
    ...
    avg_stats['Season Earnings'] = avg_stats['Drafter'].map({'Alex': '$70', 'Dave': '$130', 'Stu': '$60'})
    ...
    geography_wins = pd.Series({'Alex': 6, 'Dave': 4, 'Stu': 15})
...
st.write("This table includes all players from all tournaments. Updated July 13, 2026, after Scottish Open completion.")

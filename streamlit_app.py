...
st.write("Updated August 24, 2026 after BMW completion.")
...
if relevant_files:
    ...
    avg_stats['Season Earnings'] = avg_stats['Drafter'].map({'Alex': '$90', 'Dave': '$140', 'Stu': '$90'})
    ...
    geography_wins = pd.Series({'Alex': 7, 'Dave': 4, 'Stu': 20})
...
st.write("This table includes all players from all tournaments. Updated August 24, 2026 after BMW completion.")

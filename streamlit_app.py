...
st.write("Updated July 20, 2026, after British Open completion.")
...
if relevant_files:
    ...
    avg_stats['Season Earnings'] = avg_stats['Drafter'].map({'Alex': '$70', 'Dave': '$130', 'Stu': '$70'})
    ...
    geography_wins = pd.Series({'Alex': 6, 'Dave': 4, 'Stu': 16})
...
st.write("This table includes all players from all tournaments. Updated July 20, 2026, after British Open completion.")

...
st.write("Updated August 10, 2026, after Wyndham completion.")
...
if relevant_files:
    ...
    avg_stats['Season Earnings'] = avg_stats['Drafter'].map({'Alex': '$80', 'Dave': '$130', 'Stu': '$90'})
    ...
    geography_wins = pd.Series({'Alex': 7, 'Dave': 4, 'Stu': 18})
...
st.write("This table includes all players from all tournaments. Updated August 10, 2026, after Wyndham completion.")

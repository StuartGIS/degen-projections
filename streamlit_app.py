...
st.header("Valspar Championship")
st.markdown("Copperhead Course  \nPalm Harbor, Florida  \nMarch 19-22, 2026")
...
draft_results = pd.read_csv("Valspar_draft_results_csv.csv")
...
st.write("Updated March 17, 2026, after The Players completion.")
...
if relevant_files:
    ...
    avg_stats['Season Earnings'] = avg_stats['Drafter'].map({'Alex': '$40', 'Dave': '$40', 'Stu': '$10'})
    ...
    geography_wins = pd.Series({'Alex': 1, 'Dave': 3, 'Stu': 5})

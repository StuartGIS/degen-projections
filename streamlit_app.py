...
st.write("Updated July 5, 2026, after John Deere completion.")
...
if relevant_files:
    ...
    avg_stats['Season Earnings'] = avg_stats['Drafter'].map({'Alex': '$70', 'Dave': '$130', 'Stu': '$50'})
    ...
    geography_wins = pd.Series({'Alex': 6, 'Dave': 4, 'Stu': 14})
...
st.write("This table includes all players from all tournaments. Updated July 5, 2026, after John Deere completion.")

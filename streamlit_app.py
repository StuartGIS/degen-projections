...
st.header("Charles Schwab")
st.markdown("Colonial Country Club  \nFort Worth, Texas  \nMay 28-31, 2026")
...
draft_results = pd.read_csv("CharlesSchwab_draft_results_csv.csv")
...
st.write("Updated May 25, 2026, after CJ Cup completion.")
...
if relevant_files:
    ...
    avg_stats['Season Earnings'] = avg_stats['Drafter'].map({'Alex': '$60', 'Dave': '$80', 'Stu': '$40'})
    ...
    geography_wins = pd.Series({'Alex': 5, 'Dave': 4, 'Stu': 9})
...
st.write("This table includes all players from all tournaments. Updated May 25, 2026, after CJ Cup completion.")

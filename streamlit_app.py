...
st.write("Updated July 27, 2026, after 3M completion.")
...
if relevant_files:
    ...
    avg_stats['Season Earnings'] = avg_stats['Drafter'].map({'Alex': '$80', 'Dave': '$130', 'Stu': '$70'})
    ...
    geography_wins = pd.Series({'Alex': 6, 'Dave': 4, 'Stu': 17})
...
st.write("This table includes all players from all tournaments. Updated July 27, 2026, after 3M completion.")
